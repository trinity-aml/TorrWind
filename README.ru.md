...
- Встроенный LibVLC-плеер с навигацией по M3U-плейлистам, настройками аудио/видео/субтитров и запуском внешнего плеера.
...
Воспроизведение может использовать встроенный LibVLC-плеер или внешний плеер:
...
TorrWind генерирует совместимые с TorrServer stream или M3U URL и открывает их в выбранном плеере. Release-сборки включают Windows x64 LibVLC runtime в `libvlc/win-x64`.

Встроенный LibVLC-плеер сам читает локальные M3U-файлы и скачивает HTTP(S) M3U/M3U8-плейлисты. Для сериалов плейлист показывается как список серий, есть кнопки-пиктограммы для перехода к предыдущей/следующей серии и возможность выбрать любую серию из списка. В плеере также доступны выбор аудиодорожки, видеодорожки, субтитров, соотношения сторон, задержки аудио и задержки субтитров.
